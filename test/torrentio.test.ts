...
describe("searchTorrentio", () => {
  ...
  it("builds correct URL for movies", async () => {
    ...
    assert.equal(capturedUrl, "https://search-provider-4.example/stream/movie/tt1375666.json");
  });
  ...
  it("builds correct URL for series", async () => {
    ...
    assert.equal(capturedUrl, "https://search-provider-4.example/stream/series/tt0096697:15:1.json");
  });
});
